...
const HUB = [
  ["฿", "ราคาน้ำมัน", "ราคาขายต่อลิตร", "#fuel-prices"], ["♙", "ผู้ใช้งาน", "บัญชีพนักงาน", "#users"],
  ["⌘", "สิทธิ์", "บทบาทและการเข้าถึง", "#permissions"], ["⌂", "ข้อมูลสถานี", "ชื่อและรายละเอียด", "#station"],
